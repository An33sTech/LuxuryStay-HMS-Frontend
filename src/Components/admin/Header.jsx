...
import '../../assets/admin/plugins/datatable/js/jquery.dataTables.min.js'
import '../../assets/admin/plugins/peity/jquery.peity.min.js'

import { Link } from 'react-router-dom';
import apps13 from '../../assets/admin/images/apps/13.png';
import apps14 from '../../assets/admin/images/apps/14.png';
import avatar6 from '../../assets/admin/images/avatars/06.png';
